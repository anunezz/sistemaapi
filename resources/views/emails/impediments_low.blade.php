...
<div class="cuerpo">
    <div class="contenido">
        ...
        <p>
            <strong>Baja de impedimento</strong>
        </p>
        ...
        <p style="text-align: center;">
            En relación a su solicitud realizada el día {{ now()->format('d/m/Y') }}, se le notifica que se ha realizado la baja del impedimento.
        </p>
    </div>
