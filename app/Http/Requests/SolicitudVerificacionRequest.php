...
class SolicitudVerificacionRequest extends FormRequest
{
    use ValidatesBase64;
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'entidad_federativa_nacimiento' => ['nullable','string','max:100','regex:/^[\p{L}\p{M} ]+$/u'],
    ...
    public function messages()
    {
        return [
            ...
            'entidad_federativa_nacimiento.regex'   => 'El campo entidad_federativa_nacimiento solo puede contener letras y espacios.',
