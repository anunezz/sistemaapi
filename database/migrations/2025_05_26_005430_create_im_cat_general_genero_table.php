...
return new class extends Migration
{
    ...
    {
        Schema::create('im_cat_general_genero', function (Blueprint $table) {
            $table->id(); //TODO SE agrega ID A AUTOINCREMENTABLE
            $table->char('id_genero', 1)->unique(); //TODO SE CAMBIA A unique
        ...
        DB::statement("COMMENT ON TABLE im_cat_general_genero IS 'Catálogo de géneros generales en la aplicación de Impedimentos';");
    }
    ...
    {
        Schema::dropIfExists('im_cat_general_genero');
    }
};
