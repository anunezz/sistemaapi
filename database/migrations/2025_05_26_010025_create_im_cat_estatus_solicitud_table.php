...
return new class extends Migration
{
    ...
    {
        Schema::create('im_cat_estatus_solicitud', function (Blueprint $table) {
            $table->bigIncrements('id_estatus_solicitud'); //TODO SE CAMBIA A AUTOINCREMENTABLE
            $table->string('estatus_solicitud', 30);
        ...
        DB::statement("COMMENT ON TABLE im_cat_estatus_solicitud IS 'Catálogo de estatus de solicitud de impedimento';");
    }
    ...
    {
        Schema::dropIfExists('im_cat_estatus_solicitud');
    }
};
